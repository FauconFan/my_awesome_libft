...
static void		apply_arg_in_res_parser(void *arg_void, void *res_parser_void)
{
	...
	res_parser = (t_cli_parser *)res_parser_void;
...
void			ft_finish_res_cli_parser(
					t_cli_parser *res_parser, t_cli_builder_parser *parser)
{
	ft_slist_iterparam(parser->args, res_parser, apply_arg_in_res_parser);
}
