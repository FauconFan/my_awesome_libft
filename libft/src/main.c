...
/*   Updated: 2018/08/06 16:48:57 by jpriou           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	ft_llist_addfront(l, ft_strdup("abc"));
	ft_llist_addfront(l, ft_strdup("abcd"));
	ft_llist_addfront(l, ft_strdup("coucou"));
	ft_llist_addfront(l, ft_strdup("zebre"));
	ft_llist_iter(l, (void (*)(void *))ft_putendl);
	ft_llist_sort(&l, (int (*)(void *, void *))ft_strcmp);
	ft_llist_iter(l, (void (*)(void *))ft_putendl);
	ft_llist_free(&l);
	return 0;
}
