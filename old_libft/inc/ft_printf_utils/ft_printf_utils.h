...
void					process_normal_string(
										va_list va,
										t_treat_data *data,
										t_pf_buffer *pf);
void					process_normal_char(
										va_list va,
										t_treat_data *res,
										t_pf_buffer *pf);
...
int						process_special_char(
										va_list va,
										t_treat_data *data,
										t_pf_buffer *pf);
int						process_special_string(
										va_list va,
										t_treat_data *data,
										t_pf_buffer *pf);
...
char					*set_flags_treat_data(
										char *str,
										t_treat_data *data);
char					*set_gabarit_treat_data(
										char *str,
										t_treat_data *data,
										va_list va);
char					*set_precision_treat_data(
										char *str,
										t_treat_data *data,
										va_list va);
char					*set_length_modifer(
										char *str,
										t_treat_data *data);
char					*set_converter_treat_data(
										char *str,
										t_treat_data *data);
...
void					update_uppercase_for_l_lm(
										char letter,
										t_treat_data *data);
